 ...
 * Top headline logo (Threepoint) is centered in a prominent top row.
...
export function LogoCloud({ logos, className, ...props }: LogoCloudProps) {
  ...
  return (
    <div className={cn("mx-auto max-w-5xl space-y-4 sm:space-y-6", className)} {...props}>
          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-0 inset-x-8 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                ...
                <div className="flex items-center justify-center w-full h-full transition-transform duration-300 group-hover:scale-105">
                  <img
                    ...
                    className={cn(
                      "max-h-24 sm:max-h-32 md:max-h-36 w-auto max-w-[90%] object-contain opacity-95 transition-opacity duration-300 group-hover:opacity-100 filter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]",
      ...
      {/* ── Rows 2 to 4: Remaining Sponsors in Balanced Rows ── */}
