...
async function seed() {
  ...
  const configs = [
    ...
    { key: "scoring_weight_technical", value: "0.30", type: "NUMBER" as const },
    { key: "scoring_weight_problem", value: "0.20", type: "NUMBER" as const },
    { key: "scoring_weight_innovation", value: "0.25", type: "NUMBER" as const },
    { key: "scoring_weight_market", value: "0.15", type: "NUMBER" as const },
    { key: "scoring_weight_document", value: "0.10", type: "NUMBER" as const },
    { key: "scoring_weight_p2_mvp", value: "0.35", type: "NUMBER" as const },
    { key: "scoring_weight_p2_impact", value: "0.30", type: "NUMBER" as const },
    { key: "scoring_weight_p2_creative", value: "0.20", type: "NUMBER" as const },
    { key: "scoring_weight_p2_pitch", value: "0.15", type: "NUMBER" as const },
