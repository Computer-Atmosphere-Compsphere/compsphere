...
vec3 oklabToLin(vec3 c) {
  ...
  return vec3(
    ...
    -0.0041960863 * l - 0.7034186147 * m + 1.707614101 * s);
}
...
void main() {
  ...
  float skyGlow = smoothstep(0.11, 0.0, 1.0 - screenUv.y);
  if (skyGlow > 0.001)
    col = mix(col, mix(u_colors[1], u_colors[3], 0.9), skyGlow);
  gl_FragColor = vec4(clamp(col, 0.0, 1.0), 1.0);
}
`

const UNIFORMS = {
  colors: [[0.011764705882352941,0.10980392156862745,0.14901960784313725],[0.10588235294117647,0.4235294117647059,0.6588235294117647],[0.35294117647058826,0.8235294117647058,0.9568627450980393],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1],[0.9176470588235294,0.9764705882352941,1]] as [number, number, number][],
  colorCount: 4,
  scale: 1.300,
  intensity: 0.560,
  paramA: 0.670,
