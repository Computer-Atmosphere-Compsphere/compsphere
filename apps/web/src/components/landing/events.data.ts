    ...
    activities: [
      {
        ...
        desc: "Register individual accounts, form teams, pay Rp75,000/team, and download the Guidebook & Proposal Template.",
      },
      {
        time: "Sep 9 – Sep 18",
        title: "Submission Window",
        desc: "Prepare and submit your Idea Proposal (PDF) to the team dashboard before the Sep 18, 23:59 WIB deadline.",
      },
      {
        time: "Sep 19 – Sep 25",
        title: "Judging Window",
        desc: "5 professional IT judges evaluate proposals using the Two-Judge Overlap System (each proposal is reviewed by 2 different judges).",
      },
      {
        time: "Sep 26",
        title: "Announcement Day",
        desc: "Announcement of the Top 30 (Main List), Waiting List (Rank 31–40), and participants who receive a complimentary Talksphere ticket.",
      },
      {
        time: "Sep 26–29",
        title: "Confirmation & Waiting List",
        desc: "Top 30 teams confirm offline attendance. Vacant slots are filled from the Waiting List in order.",
      },
      {
        time: "Sep 30",
        title: "Online Technical Meeting",
        desc: "Offline Round briefing via Zoom/GMeet: check-in time, permitted items, and 24-hour coding rules.",
      },
      {
        time: "Oct 10 · 07:40",
        title: "Offline Round Check-In",
        desc: "Re-registration at the Auditorium, scan QR for attendance, and seat assignment by queue number.",
      },
      {
        time: "Oct 10 · 10:00",
        title: "Hacking Period Starts",
        desc: "24-hour coding begins. Teams manage their own rest and meal breaks independently.",
      },
      {
        time: "Oct 11 · 10:00",
        title: "Code Freeze & Submission",
        desc: "Coding stops. Required submissions: GitHub Repo, PDF Slides, and a deployment/live access link.",
      },
      {
        time: "Oct 11 · 10:30",
        title: "Live Pitching",
        desc: "10-minute presentation per team: 3-min business narrative, 3-min live demo, 4-min Q&A with judges.",
      },
      {
        time: "Oct 11 · End",
        title: "Winners & Closing",
        desc: "Winner announcement, prize ceremony, and the official closing of Hacksphere 2026.",
      },
    ],
