...
export const paymentService = {
     ...
     */
    async submitVerification(teamId, userId, amount, proofStorageKey, proofFilename) {
     ...
     */
    async verifyPayment(adminId, paymentId) {
        return await db.transaction(async (tx) => {
     ...
     */
    async rejectPayment(adminId, paymentId, reason) {
        if (!reason)
